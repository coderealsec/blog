...
/**
 * Dashboard için blog yazıları API'si
 * Hem taslak hem yayınlanmış yazıları gösterir
 * 
...
async function handler(req, res) {
  try {
    ...
    if (req.method === 'GET') {
      ...
      // Editörler sadece kendi yazılarını görebilir
      if (session.user.role === 'EDITOR') {
        where.authorId = session.user.id;
      } else if (authorId) {
        // Admin ise ve authorId belirtilmişse, o yazarın yazılarını filtrele
      ...
      const validOrderFields = ['publishedAt', 'createdAt', 'title', 'viewCount', 'updatedAt'];
      ...
      // Bu endpoint için /api/blog endpoint'i kullanılıyor, burada da aynı işlevi sağlayabiliriz
      // Ya da dashboard'a özel ekstra özellikler eklenebilir
